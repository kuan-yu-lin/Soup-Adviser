...
from tools.regextemplates.rules.parsing.parsers.messageparser.messageparser import MessageParser
...
from tools.regextemplates.rules.parsing.parsers.codeparser.codeparser import CodeParser
